...
export const fetchCollections = createAsyncThunk('collection/fetchCollections', async (_, { rejectWithValue }) => {
    try {
        ...
        const response = await api.get('collection/get', axiosConfig) //NEED WITH CREDENTIALS TO SEND COOKIE
...
export const addCollection = createAsyncThunk('collection/addCollectionApi', async (_, { rejectWithValue }) => {
    try {
        ...
        //Send a get request to express server
        const response = await api.put('collection/add', {}, { withCredentials: true }) //newCollection can be accessed by req.body
...
export const updateCollectionName = createAsyncThunk('collection/updateCollectionName', async ({ name, collectionId }, { rejectWithValue }) => {
    try {
        ...
        //Send a get request to express server
        const response = await api.put('collection/updateName', { name: newName, collectionId: currentCollectionId }, axiosConfig) //newCollection can be accessed by req.body
...
export const deleteCollection = createAsyncThunk('collection/deleteCollection', async (collectionId, { rejectWithValue }) => {
    try {
        ...
        //Send a get request to express server
        const response = await api.put(`collection/delete`, { data: collectionId }, axiosConfig) //need data field if using delete
